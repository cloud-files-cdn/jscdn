document.write('<footer id="footer"><div id="footer-wrapper"><div class="footer-info"><div id="footLink"></div><div class="clear"></div><div class="footer-border"></div><h5 class="no-marg-bott padd-top padd-bott5">联系方式：thecangjg@gmail.com</h5><div style="clear: both;"></div></div><div class="footer-border padd-top15"></div><p>警告: 此网站只适合十八岁或以上人士观看, 此网站内容可能令人反感；不可将此区域的内容派发，传阅，出售，出租，交给或者 借予年龄未满18岁的人士或将本网站内容向该人士出售，播放或放映，如果你是该影片的版权方所有者而要求删除影片的，请联系我们，我们会很快做出回复。WARNING!By accessing the Website, you certify that you are at least 18 years of age or the age of majority under the laws of your state, province or country. We expressly and strictly limit use of the Website to adults over 18 years of age or the age of majority in the individual’s jurisdiction, whichever is greater. Anyone under this age is strictly forbidden from using the Website.</p><div class="clear"></div></div></footer>');
if($('.index_list').length > 0)
{
	$('#footLink').append('<h5 class="no-marg-bott padd-top padd-bott5">友情链接：</h5><ul class="footer-menu">'+
